...
describe('Comments routes for success', () => {
  ...
  const pathPostComments = `${API_ENPOINTS.POST_COMMENTS.replace(':id', postId.toString())}`;
  const pathPostCommentsId = `${API_ENPOINTS.POST_COMMENT_BY_ID.replace(':id', postId.toString()).replace(':commentId', '1')}`;
  ...
  it(`GET ${API_ENPOINTS.COMMENTS} success`, async () => {
    const res = await requestApp.get(API_ENPOINTS.COMMENTS);
  ...
  it(`GET ${API_ENPOINTS.POST_COMMENTS} success`, async () => {
  ...
  it(`GET ${API_ENPOINTS.POST_COMMENT_BY_ID} success`, async () => {
  ...
  it(`POST ${API_ENPOINTS.POST_COMMENTS} success`, async () => {
  ...
  it(`DELET ${API_ENPOINTS.POST_COMMENTS} success`, async () => {
  ...
  it(`DELET ${API_ENPOINTS.POST_COMMENT_BY_ID} success`, async () => {
